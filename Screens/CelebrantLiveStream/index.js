...
// import { onboardLive } from "../../store/actions/onboard-screen"
...
// import GuysAtParty from "../../assest/images/guysAtParty.svg";
...
const CelebrantLiveStream = () => {
	...
	return (
        ...
        lastStepNextButton={<Button onClick={handleDisableModal}>Okay</Button>}
      ...
      /> */}
			...
			>
				...
				>
					...
					>
						<CloseSharpIcon
							sx={{ color: "white", fontSize: "1.5rem", fontWeight: "bolder" }}
						/>
					</Box>
				</Stack>
				<Stack
