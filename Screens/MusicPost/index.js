...
// import { ReactComponent as MusicalIcon } from "../../assest/images/musicalnotes.svg";
import {
	Container,
	Box,
	List,
...
const MusicPost = () => {
	...
	return (
		<Container className={classes.root}>
			<Header type="nav" title="Music post" leftLink="/party/details" leftIcon={<BsChevronLeft />} primary />
			{musiclist?.length > 0 ? (
				<Box>
				...
				<Box
					sx={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", maxHeight: "90vh", height: "85vh", width: "100%" }}
				>
					<Box sx={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "2rem 0rem" }}>
						<img src="https://res.cloudinary.com/de8vrxbqq/image/upload/v1644325907/shout/musicalnotes_sdc2eh.svg" alt="musical_note" className={classes.img} />
					</Box>
					...
					<Box onClick={() => handleMusicDrawer(true)} sx={{ width: "50%", marginTop: "1.5rem", marginBottom: "1.5rem", backgroundColor: "transparent" }}>
						<Button
							sx={{ backgroundColor: "#110066", color: "white", textTransform: "capitalize", padding: ".8rem 0rem", borderRadius: "10px", fontWeight: "bold" }}
							variant="contained"
							fullWidth
						>
							Select songs
