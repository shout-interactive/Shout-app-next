  ...
  const list = () => (
    <Box sx={{ width: "auto" }} role="presentation">
      <Box className={classes.bottomDrawerWrapper}>
        ...
        <Box onClick={handleAddMusic} sx={{ marginTop: ".5rem" }} className={classes.buttonWrapper}>
          <Button
            sx={{
      ...
      <ModalComponent show={openModal} toggleModal={handleToggleModal}>
        <Container className={classes.container}>
          <Box className={classes.modalBox}>
            ...
            />
            <ButtonComponent title="Okay" handleClick={handleReturnMusicPost} button="#162767" />
          </Box>
        </Container>
      </ModalComponent>
    </div>
